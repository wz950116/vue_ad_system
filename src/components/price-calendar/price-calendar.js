...
module.exports = {
    ...
    methods: {
        ...
        getRange (day) {
            ...
            if(day.dateTimestamp && this.startDate && (day.dateTimestamp < this.startDate.dateTimestamp)) {
            ...
            //遍历起止日期间的所有日期
            var startDateTimestamp = this.startDate && this.startDate.dateTimestamp;
            var endDateTimestamp = this.endDate && this.endDate.dateTimestamp;
