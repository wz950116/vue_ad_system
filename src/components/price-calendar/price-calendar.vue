        ...
        <div v-show="show" class="date-calendar-root" @click="closeCalendar">
            <div ref="dateCalendar" class="date-calendar-wrap" @click.stop="">
                <calendar 
                    ...
                    v-on:daterange="getRange" 
                    :selectDays="getSelectDays" 
                    :calendar="calendarData.leftData" 
                    order="1">
                </calendar>
                <calendar 
                    class="calendar" 
                    ...
                    v-on:daterange="getRange" 
                    :selectDays="getSelectDays" 
                    :calendar="calendarData.rightData" 
                    order="2">
                </calendar>
                <p class="priceTotal">
                    已选择  <em class="hot">{{dateRangeCount}}</em> 天，共 <em class="hot">{{priceTotal}}</em> 元
...
<script src='./price-calendar.js'></script>
